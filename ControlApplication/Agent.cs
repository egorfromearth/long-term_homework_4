...
namespace ControlApplication
{
    public class Agent
    {
        ...
        public Dictionary<Task, string[]> Tasks { get; set; }
        public SystemInformation Info { get; private set; }

        public delegate void DisconnectAgentHandler(Dictionary<Task, string[]> tasks, ref List <Agent> agentsList);
        ...
        public Agent(int idAgent, SystemInformation info, string queueSend, string queueReceive)
        {
            ...
            Tasks = new Dictionary<Task, string[]>();
            Connect = false;
        }
    }
}